        ...
                   """)
            ...
            while answer1.lower() != user_answer1.lower():
                ...
                if attempt >= 5:
                    hint1 = list(answer1)
                    if i == len(answer1):
                        print(f"Hint: answer is {answer1}")
                    else:
                        print(f"Hint: answer starts with {hint1[0:i]}")
                        i += 1
                user_answer1 = input("Answer: ")
            print("Correct")
        ...
        if turn == 2:
            ...
            while answer2.lower() != user_answer2.lower():
                ...
                if attempt >= 5:
                    hint2 = list(answer2)
                    if i == len(answer2):
                        print(f"Hint: answer is {answer2}")
                    else:
                        print(f"Hint: answer starts with {hint2[0:i]}")
                        i += 1                
                user_answer2 = input("Answer: ")
            print("Correct") 
        ...
        if turn == 3:
            ...
            while answer3.lower() != user_answer3.lower():
                ...
                if attempt >= 5:
                    hint3 = list(answer3)
                    if i == len(answer3):
                        print(f"Hint: answer is {answer3}")
                    else:
                        print(f"Hint: answer starts with {hint3[0:i]}")
                        i += 1                
                user_answer3 = input("Answer: ")
            print("Correct")  
...
attempts_per_ch = Challenge.ch1_1_challenge(self)
for i in range(3):
    attempts_per_ch = Challenge.ch2_challenge(self, turns)
    turns += 1
